  ...
  return (
    <section id="home" className="min-h-screen flex items-center justify-center gradient-hero relative overflow-hidden">
      ...
      <div className="absolute inset-0 opacity-10">
        ...
        <div className="absolute top-40 right-10 w-72 h-72 bg-primary-glow rounded-full mix-blend-multiply filter blur-xl animate-float" style={{ animationDelay: '2s' }}></div>
        <div className="absolute -bottom-8 left-20 w-72 h-72 bg-accent rounded-full mix-blend-multiply filter blur-xl animate-float" style={{ animationDelay: '4s' }}></div>
      </div>
        ...
        <div className="text-center">
          ...
          >
            <a
              ...
              className="text-primary-foreground/70 hover:text-accent transition-colors transform hover:scale-110 duration-300"
            >
              <Linkedin size={32} />
            </a>
            <a
